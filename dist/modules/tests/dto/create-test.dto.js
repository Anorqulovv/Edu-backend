...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 1, description: "Yo'nalish ID (optional)" }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], CreateTestDto.prototype, "directionId", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 1, description: 'Guruh ID (optional)' }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], CreateTestDto.prototype, "groupId", void 0);
